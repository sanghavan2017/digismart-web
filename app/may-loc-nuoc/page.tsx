...
export const metadata: Metadata = {
  ...
  description:
    "Máy lọc nước AO Smith, Mitsubishi Cleansui chính hãng — RO nhiều cấp lọc, nóng lạnh tiện lợi. Tư vấn miễn phí, lắp đặt tận nơi tại TPHCM.",
};
...
const benefits = [
  { icon: "💧", title: "Công nghệ lọc RO", desc: "Loại bỏ vi khuẩn, tạp chất, kim loại nặng — giữ lại khoáng chất có lợi cho sức khỏe." },
  { icon: "🏷️", title: "Hàng chính hãng 100%", desc: "Phân phối trực tiếp AO Smith, Mitsubishi Cleansui — đầy đủ tem, phiếu bảo hành." },
  { icon: "🔧", title: "Lắp đặt tận nơi", desc: "Đội ngũ kỹ thuật lắp đặt nhanh chóng, hướng dẫn sử dụng và bảo trì tận tình." },
        ...
        <div className="container" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "2rem", alignItems: "center" }}>
          <div>
            ...
            <p style={{ fontFamily: "Calibri, sans-serif", color: "rgba(255,255,255,0.85)", fontSize: "1rem", lineHeight: 1.7, marginBottom: "1.5rem" }}>
              DigiSmart cung cấp & lắp đặt máy lọc nước AO Smith, Mitsubishi Cleansui chính hãng — công nghệ RO nhiều cấp lọc, nóng lạnh tiện lợi cho cả gia đình.
            </p>

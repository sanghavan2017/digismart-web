    ...
    <>
      ...
      <section style={{ background: "linear-gradient(135deg, #042C53 0%, #185FA5 100%)", padding: "3.5rem 0" }}>
        <div className="container">
          <h1 style={{ fontFamily: "'Trebuchet MS', sans-serif", fontSize: "clamp(1.6rem, 4vw, 2.2rem)", color: "#fff", marginBottom: "0.75rem" }}>
            Kiến thức <span style={{ color: "#F07B20" }}>nước sạch</span>
          </h1>
          <p style={{ fontFamily: "Calibri, sans-serif", color: "rgba(255,255,255,0.85)", fontSize: "1rem", maxWidth: 640 }}>
            ...
            {articles.map(a => (
              <div key={a.videoId} style={{ background: "#fff", borderRadius: 12, border: "1px solid var(--border)", overflow: "hidden" }}>
                ...
                <div style={{ padding: "1.25rem" }}>
                  <h2 style={{ fontFamily: "'Trebuchet MS', sans-serif", fontSize: "1rem", color: "var(--brand)", marginBottom: "0.5rem", lineHeight: 1.4 }}>
                    {a.title}
                  </h2>
      ...
      <section style={{ padding: "3rem 0", background: "#fff" }}>
        <div className="container" style={{ maxWidth: 480, textAlign: "center" }}>
          ...
          <p style={{ fontFamily: "Calibri, sans-serif", fontSize: "0.9rem", color: "var(--text)", marginBottom: "1.5rem" }}>

    ...
    <>
        ...
        <div className="container" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "2rem", flexWrap: "wrap" }}>
          <div style={{ color: "#fff", maxWidth: 540 }}>
            ...
            <h1 style={{ fontFamily: "'Trebuchet MS', sans-serif", fontSize: "clamp(2rem, 4vw, 2.8rem)", lineHeight: 1.2, marginBottom: "0.75rem" }}>
              Gia dụng chính hãng<br />
              <span style={{ color: "#F07B20" }}>— Công nghệ đỉnh cao</span>
            </h1>
            ...
            <p style={{ fontFamily: "Calibri, sans-serif", fontSize: "0.9rem", opacity: 0.75, lineHeight: 1.7, marginBottom: "2rem" }}>
              Thiết bị diệt côn trùng, gia dụng nhà bếp, chăm sóc cá nhân chính hãng — bảo hành đầy đủ.
            </p>
      ...
      <section style={{ padding: "3rem 0", background: "#fff" }}>
        <div className="container">
          <h2 style={{ fontFamily: "'Trebuchet MS', sans-serif", fontSize: "1.5rem", marginBottom: "1.5rem", color: "var(--brand)" }}>Danh mục sản phẩm</h2>
      ...
      <section style={{ padding: "3rem 0", background: "var(--bg)" }}>
        <div className="container">
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem" }}>
            ...
            <Link href="/san-pham" style={{ color: "var(--brand2)", fontWeight: 600, fontSize: "0.9rem", textDecoration: "none", fontFamily: "Trebuchet MS, sans-serif" }}>Xem tất cả →</Link>
          </div>
            ...
            {featured.map(p => (
              <Link key={p.id} href={`/san-pham/${p.id}`}
                ...
                <div style={{ padding: "1rem" }}>
                  <div style={{ fontFamily: "Calibri, sans-serif", fontSize: "0.7rem", color: "var(--muted)", textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 4 }}>{p.brand}</div>
                  <div style={{ fontFamily: "'Trebuchet MS', sans-serif", fontWeight: 700, fontSize: "0.88rem", marginBottom: "0.5rem", color: "var(--text)", lineHeight: 1.4 }}>{p.name}</div>
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    <span style={{ fontFamily: "'Trebuchet MS', sans-serif", fontSize: "1.05rem", fontWeight: 700, color: "var(--brand2)" }}>{formatPrice(p.price)}</span>
                    <span style={{ fontFamily: "Calibri, sans-serif", fontSize: "0.8rem", color: "var(--muted)", textDecoration: "line-through" }}>{formatPrice(p.originalPrice)}</span>
                  </div>
                </div>
              </Link>
            ))}
        ...
        <div className="container">
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "1.5rem" }}>
            {[
              ...
              { icon: "🚀", title: "Giao hàng nhanh", desc: "Toàn quốc qua Shopee, Lazada" },
      ...
      <section style={{ background: "var(--brand)", padding: "3rem 0", textAlign: "center" }}>
        <div className="container">
          <h2 style={{ fontFamily: "'Trebuchet MS', sans-serif", fontSize: "1.7rem", color: "#fff", marginBottom: "0.75rem" }}>Cần tư vấn sản phẩm?</h2>
          <p style={{ fontFamily: "Calibri, sans-serif", color: "rgba(255,255,255,0.8)", marginBottom: "1.5rem" }}>Liên hệ ngay để được hỗ trợ nhanh nhất</p>
          <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <a href="https://zalo.me/0778886758" target="_blank" style={{ background: "transparent", color: "#fff", border: "1.5px solid rgba(255,255,255,0.5)", padding: "12px 28px", borderRadius: 6, fontWeight: 500, textDecoration: "none", fontFamily: "Trebuchet MS, sans-serif" }}>
              💬 Chat Zalo
            </a>
          </div>
        </div>
